...
// is made transparent.
var savedBodyBg = null;
var savedBodyImage = null;
var savedHtmlBg = null;
var savedHtmlImage = null;

function clearBackground() {
  var body = document.body;
  if (body.style) {
    savedBodyBg = body.style.backgroundColor;
    savedBodyImage = body.style.backgroundImage;
    ...
    if (body.parentNode && body.parentNode.style) {
      savedHtmlBg = body.parentNode.style.backgroundColor;
      savedHtmlImage = body.parentNode.style.backgroundImage;
...
function restoreBackground() {
  ...
  if (body.style) {
    ...
    body.style.backgroundImage = savedBodyImage || '';
    if (body.parentNode && body.parentNode.style) {
      body.parentNode.style.backgroundColor = savedHtmlBg || '';
      body.parentNode.style.backgroundImage = savedHtmlImage || '';
    }
  }
}
...
function doneCallback(callback, clear, restore) {
  if (!callback) {
    return null;
  }
  return function(statusDict) {
...
return {
  ...
  destroy: function(callback) {
    cordova.exec(doneCallback(callback, false, true), null, 'QRScanner', 'destroy', []);
  },
  ...
  hide: function(callback) {
    cordova.exec(doneCallback(callback, false, true), null, 'QRScanner', 'hide', []);
  },
